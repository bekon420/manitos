...
<head>
    ...
    <title>Mujer - Manitos Shoe Store</title>
...
<body>
    ...
    <div class="container">
        <h1>Calzado y Ropa para Mujer</h1>
        <div class="products">
            <div class="product">
                <img src="./Images/yezezy_desierto.avif" alt="Shoe 1">
                <h3>Tenis Puma Fierce</h3>
                <p>$3000</p>
            </div>
            <div class="product">
                <img src="./Images/kobe.avif" alt="Shoe 2">
